...
screen language_menu:
    ...
    frame background Frame(get_image("gui/choice/day/choice_box.png"),50,50) xfill True yalign 0.5 left_padding 75 right_padding 75 bottom_padding 50 top_padding 50:
        ...
        grid 1 6 xfill True:
            ...
            hbox xalign 0.5:
                if _preferences.language == "latvian":
                    add get_image("gui/settings/leaf.png") ypos 0.24
                else:
                    null width 22
                textbutton translation_new["Latvian"] style "log_button" text_style "sprite_menu" action (SetField(config, "window_title", "Everlasting Summer"), SetField(persistent, "show_hentai_ach", False), Language("latvian"), Function(reload_names), Function(stop_music), Function(renpy.utter_restart))
